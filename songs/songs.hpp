...
static std::vector<uint32_t> durationsNokia = {
...
static std::vector<uint32_t> melodyStarWars = {
    ...
    NOTE_C6, NOTE_AS5, NOTE_A5, NOTE_G5, NOTE_F6, NOTE_C6, NOTE_AS5,
    NOTE_A5, NOTE_AS5, NOTE_G5, NOTE_C5, NOTE_C5, NOTE_D5, NOTE_D5,
    NOTE_AS5, NOTE_A5, NOTE_G5, NOTE_F5, NOTE_F5, NOTE_G5, NOTE_A5,
    NOTE_G5, NOTE_D5, NOTE_E5, NOTE_C5, NOTE_C5, NOTE_D5, NOTE_D5,
    NOTE_AS5, NOTE_A5, NOTE_G5, NOTE_F5, NOTE_C6, NOTE_G5, NOTE_G5,
    REST, NOTE_C5, NOTE_D5, NOTE_D5, NOTE_AS5, NOTE_A5, NOTE_G5,
    NOTE_F5, NOTE_F5, NOTE_G5, NOTE_A5, NOTE_G5, NOTE_D5, NOTE_E5,
    NOTE_C6, NOTE_C6, NOTE_F6, NOTE_DS6, NOTE_CS6, NOTE_C6, NOTE_AS5,
...
static std::vector<uint32_t> melodyGiveYouUp = {
    ...
    NOTE_B4, NOTE_A4, NOTE_G4, REST, NOTE_G4, REST, NOTE_D5, REST,
    NOTE_C5, REST,
    NOTE_G4, NOTE_A4, NOTE_C5, NOTE_A4, NOTE_E5, NOTE_E5, REST,
    NOTE_D5, REST,
    ...
    NOTE_B4, NOTE_A4, NOTE_G4, REST, NOTE_G4, REST, NOTE_D5, REST,
    NOTE_C5, REST,
    NOTE_C5, REST, NOTE_D5, REST, NOTE_G4, REST, NOTE_D5, REST,
    NOTE_E5, REST,
    NOTE_G5, NOTE_F5, NOTE_E5, REST,
    NOTE_C5, REST, NOTE_D5, REST, NOTE_G4, REST
};

static std::vector<uint32_t> durationsGiveYouUp = {
    8, 8, 8, 8, 8, 8, 8, 4,
    8, 8, 8, 8, 2, 2,
    8, 8, 8, 8, 2, 8, 8,
    2, 8,
...
static std::vector<uint32_t> melodyTetris = {
...
static std::vector<uint32_t> durationsTetris = {
    4, 8, 8, 4, 8, 8,
    4, 8, 8, 4, 8, 8,
    4, 8, 4, 4,
    4, 4, 8, 4, 8, 8,
